...
SELECT COUNT(*) AS Total_Students FROM Students; -- Average course fee 
SELECT AVG(fee) AS Avg_Fee FROM Courses; -- Maximum and Minimum fee 
...
FROM Enrollments; -- Students older than 21 years (as of 2025) 
...
ORDER BY Total_Students DESC; -- Courses ordered by fee 
SELECT * FROM Courses 
ORDER BY fee DESC; 
Stored Procedures 
